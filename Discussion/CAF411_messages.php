...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    ...
    alert("You need to log in first to access this page."); //window.location.href = "login.php";
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO CAF411_messages (name, message, timestamp) VALUES ('$name', '$message', NOW())";
...
$sql = "SELECT * FROM CAF411_messages ORDER BY timestamp";
...
<head>
    <link rel="stylesheet" href="../Stylesheet/Full_Stylesheet.css">
        ...
        <script type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></alert>
        <script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
    <title>CAF411 Discussion</title>
    <style>
