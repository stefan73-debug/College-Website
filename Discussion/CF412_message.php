...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO CF412_messages (name, message, timestamp) VALUES ('$name', '$message', NOW())";
...
$sql = "SELECT * FROM CF412_messages ORDER BY timestamp";
            ...
            <div class="footer-section2">
                ...
                <nav>
                    <ul class="space">
                        ...
                        <br>
                        <li><a href="../Shared Resources/shared_resources.php recources.php">Shared Resources</a></li>
