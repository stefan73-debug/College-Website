...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO DLP411_messages (name, message, timestamp) VALUES ('$name', '$message', NOW())";
...
$sql = "SELECT * FROM DLP411_messages ORDER BY timestamp";
