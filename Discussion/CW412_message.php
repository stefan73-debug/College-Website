...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO CW412_messages (name, message, timestamp) VALUES ('$name', '$message', NOW())";
...
$sql = "SELECT * FROM CW412_messages ORDER BY timestamp";
