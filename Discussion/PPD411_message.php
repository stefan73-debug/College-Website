...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO PPD411_messages (name, message, timestamp) VALUES ('$name', '$message', NOW())";
...
$sql = "SELECT * FROM PPD411_messages ORDER BY timestamp";
