    ...
    <body>
        ...
        <div style="height: 10%;">
            ...
            if(isset($_POST['upload'])) {
                ...
                $stmt = $conn->prepare("INSERT INTO dlp411_files (file_name, file_data) VALUES (?, ?)");
            ...
            <?php
            // Establish a database connection (you may need to modify this)
            $conn = new mysqli("localhost", "root", "", "secretangentbennie");

            if($conn->connect_error) {
                die("Connection failed: " . $conn->connect_error);
            }

            $sql = "SELECT id, file_name FROM dlp411_files";
