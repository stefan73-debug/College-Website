...
<html lang="en">
    ...
    <body>
        <header>
                        ...
                        <div class="cont_login">
                            ...
                            <div class="cont_forms" >
                                ...
                                <div class="cont_form_login">
                                    <a href="shared_resources.php" onclick="hidden_login_and_sign_up()" >
            ...
            <div class="navigation" style="z-index: 100;">
                <ul>
                    ...
                    <li>
                        <a href="shared_resources.html"> <!--Link to the Share Resources page-->
                            <span class="icon">
        ...
        <h1 id="DiscH">Welcome to the Shared Resources page:</h1>
        <p class="h1">
            Please select a module below to enter the Resources area
        </p>
            ...
            <div class="Hfooter-content">
                ...
                <nav>
                    <ul class="space">
                        ...
                        <br>
                        <li><a href="shared_resources.html">Shared Resources</a></li>
        ...
        <script>
            ...
            function handleLogin(event) {
                ...
                window.location.href = "shared_resources.html"; // Redirect to home page
                return false;
            }
            ...
            function testLogin()
            {
                window.location.href = "shared_resources.html";
            }
        </script>
</body>
</html>